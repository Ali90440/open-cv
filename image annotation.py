...
# Draw to rectangles Around Intersting Regions
# Rectangle 1: around the top-left corner
...
cv2.circle(image_rgb, (center1_x, center1_y), 15, (0, 255, 0), -1) # blue circle at center of rect1
cv2.circle(image_rgb, (center2_x, center2_y), 15, (0, 255, 0), -1) # blue circle at center of rect2

cv2.line(image_rgb, (center1_x, center1_y), (center2_x, center2_y), (0, 255, 0), 3) # red line connecting centers

plt.figure(figsize=(12, 8))
plt.imshow(image_rgb)
plt.title("Annotated Image with Rectangles")
plt.axis('off')
plt.show()